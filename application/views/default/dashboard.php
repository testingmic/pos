  ...
  <div class="container-fluid">
    <div class="header-body">
      <div class="row align-items-center py-4">
        ...
        <div class="col-md-4 text-right" title="This is the selected current branch to record a sale from a customer.">
          <strong>Branch: </strong> <?= $branchesList[$session->branchId]->branch_name; ?>
        </div>
      </div>
      <!-- Card stats -->
      <div class="row">
