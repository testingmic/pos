...
global $posClass, $branchesList, $clientData;
...
<div class="container-fluid">
    ...
    <div class="row">
        <?= $posClass->handleBranchesDisplay($branchesList, $branchAccess, $session, "mt--5 mb-0"); ?>
                        ...
                        <div class="tab-pane fade show active" id="sales_details">
                            <div class="card">
                                ...
                                <div class="card-body request-form">
                                    ...
                                    <button class="<?= $clientData->bg_color; ?> btn-block btn">
                                        <h3 class="text-white"><span class="font-16"><?= $clientData->default_currency ?></span> <span class="total-to-pay-amount" data-order-total='0'>0.00</span></h3>
                                    </button>
                                </div>
                            </div><!--end row-->
